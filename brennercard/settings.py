"""
Django settings for brennercard project.
...
WSGI_APPLICATION = 'brennercard.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './brennercard.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
